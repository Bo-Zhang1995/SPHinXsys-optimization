...
int main()
{
	...
	boundary_averaged_temperature = calculate_boundary_averaged_temperature.parallel_exec();
		...
		relative_average_variation_difference > 0.00001) && ite_loop < 5000)
	{
		...
		else if ((nonopt_averaged_temperature < opt_averaged_temperature) && (ite_loop > 100))
		{
